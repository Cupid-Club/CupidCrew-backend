...
//    @param:Qualifier("candidateJpaQueryFactory") private val jpaQueryFactory: JPAQueryFactory,
...
//
//        val field = PathBuilder(CandidateEntity::class.java, candidate.metadata.name).getNumber(fieldName, Long::class.java)
//
//        jpaQueryFactory.update(candidate)
